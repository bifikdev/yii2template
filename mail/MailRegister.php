...
$url = sprintf('https://%s/activate.html?activateKey=%s', $server, $activateKey);
?>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        <?= $username ?>, подтвердите регистрацию своей учетной записи перейдя по
                                        ссылке ниже.
                                    </td>
                                </tr>
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        &copy; TechnicalWorld 2013 - <?= date('Y') ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
